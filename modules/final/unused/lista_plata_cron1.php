...
function select_asoc(value) {
 window.location = "index.php?link=XXX&asoc_id=" + value;	
}
function select_scara(value,value2) {
 window.location = "index.php?link=XXX&asoc_id=" + value + "&scara_id=" + value2;	
}
function select_luna(value,value2,value3) {
 window.location = "index.php?link=XXX&asoc_id=" + value + "&scara_id=" + value2 + "&luna=" + value3;	
}
...
function put_luna($asoc_id, $scara_id){
	$luna_curr = date('Y-m-d');
	
	$sql = "SELECT * FROM lista_plata WHERE asoc_id=".$asoc_id." AND scara_id=".$scara_id;
