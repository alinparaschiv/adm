...
<script language="javascript"> 
        ...
        function infoScari(obj) {
            window.location = "index.php?link=XXX&asoc_id=<?php echo $asocId; ?>&scara="+obj
        }
        function infoAsoc(obj) {
            window.location = "index.php?link=XXX&asoc_id="+obj            
        }
...
<div id="maincon"  style="text-align:left;">
        <form id="addForm1" name="addForm1" method="post" action="index.php?link=XXX&asoc_id=<?php echo $asocId; ?>">                       
                    Asociatia:                                
                    <?php 
                           if ($_SESSION['uid'] == 0){
...
function functionStergeFur(furnizor,fur_id){
     ...
     if(answer)
        window.location = "<?php echo 'index.php?link=XXX&asoc_id='.$asocId.'&sterge='; ?>"+fur_id;
}
...
$scara = '';
echo '<form id="formEdit1" name="formEdit1" method="post" action="index.php?link=XXX&asoc_id='.$asocId.'&scara_id='.$scaraP.'">';
                ...
                while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {                                    
                    ...
                    echo '<input type="hidden" name="scara_'.$row['ap'].'" value="'.$row['scara_id'].'">';
                            ...
                            if ($editLoc == $row['a_id']) {                    
                                    ...
                                    echo '<td>
                                                <center><a style="font-size:12px;" href="index.php?link=XXX&asoc_id='.$asocId.'&scara_id='.$scaraP.'&edit='.$row['a_id'].'">[edit]</a>&nbsp;&nbsp;&nbsp;</center>
                                          </td>';
                    $m++;                   
                    }                                                                                  
                    echo '</table>';     
