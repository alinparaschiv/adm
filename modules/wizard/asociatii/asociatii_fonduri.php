...
////////////////////    NU MAI ESTE FOLOSIT ACEST MODUL ////////////////////////////////////////
...
if ($_GET['asoc_id'] != '') $asocId = mysql_real_escape_string($_GET['asoc_id']);
...
<?php
if ($link=='w_asoc_fonduri') {
    echo '<form id="addForm" name="addForm" method="post" action="index.php?link=w_asoc_fonduri&asoc_id='.$asocId.'">';
...
?>
                ...
                <table cellspacing=5 style="margin:20px 0 0 0px; width:300px;" border=0>
                        ...
                        */
                        ...
                        <tr><td>Fond Reparatii:</td><td><input type="text" name="reparatii" value="<?php echo $_POST['reparatii'];?>" /></td></tr>
                        <?php if ($errSpecial != '') echo '<tr><td></td><td><font color="red">'.$errSpecial.'</font></td></tr>'; ?>
                        <tr><td>Fond Special:</td><td><input type="text" name="special" value="<?php echo $_POST['special'];?>" /></td></tr>
                        <?php if ($errRulment != '') echo '<tr><td></td><td><font color="red">'.$errRulment.'</font></td></tr>'; ?>
                        <tr><td>Fond Rulment:</td><td><input type="text" name="rulment" value="<?php echo $_POST['rulment'];?>" /></td></tr>
                        <?php if ($errPenalizari != '') echo '<tr><td></td><td><font color="red">'.$errPenalizari.'</font></td></tr>'; ?>
                        <tr><td>Fond Penalizari:</td><td><input type="text" name="penalizari" value="<?php echo $_POST['penalizari'];?>" /></td></tr>
                        ...
                        <tr>
                            ...
                            <td><div id="buton"><a href="index.php?link=w_asoc_setari&asoc_id=<?php echo $asocId; ?>" style="">Pasul Urmator</a></div></td>
                        </tr>
...
function functionStergeFur(furnizor,fur_id){
     ...
     if(answer)
        window.location = "<?php echo 'index.php?link=w_asoc_fonduri&asoc_id='.$asocId.'&sterge='; ?>"+fur_id;
}
...
?>
    <table width=600>
           <tr bgcolor="#19AF62">
               ...
               <td><font size=2 color="white"><center>Reparatii</center></font></td>
               <td><font size=2 color="white"><center>Special</center></font></td>
               <td><font size=2 color="white"><center>Rulment</center></font></td>
               <td><font size=2 color="white"><center>Penalizari</center></font></td>
           ...
           <?php
              ...
              while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
                   ...
                   if ($i %2 == 0) echo '<tr align=center>'; else echo '<tr align=center bgcolor="#f1f2f2">';
                        if ($editAf == $row['af_id']){
                                echo '<form name="formEdit" id="formEdit" method="post" action="index.php?link=w_asoc_fonduri&asoc_id='.$asocId.'">';
                                ...
                                echo '<td><center>
                                                <a style="font-size:12px;" href="index.php?link=w_asoc_fonduri&asoc_id='.$asocId.'&edit='.$row['af_id'].'">[edit]</a>&nbsp;&nbsp;&nbsp;
