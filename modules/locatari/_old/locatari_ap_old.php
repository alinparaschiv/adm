...
<div id="maincon"  style="text-align:left;">
        <form id="addForm1" name="addForm1" method="post" action="index.php?link=locatari_ap&asoc_id=<?php echo $asocId; ?>">                       
                    ...
                    <?php                
                            ...
                            echo '</select>';
                    echo '<br /><input type="submit" name="afiseaza" value="Afiseaza" />';
                    ?>
        ...
        echo '<form id="addForm" name="addForm" method="post" action="index.php?link=locatari_ap&asoc_id='.$asocId.'">';
                ...
                <br />
                        <?php
                              ...
                              $query = "SELECT L.*, S.scara FROM locatari AS L JOIN scari AS S ON L.scara_id=S.scara_id WHERE L.asoc_id='$asocId' ORDER BY L.loc_id ASC";
                              if ($scaraP != '') 
                                    $query = "SELECT L.*, S.scara FROM locatari AS L JOIN scari AS S ON L.scara_id=S.scara_id WHERE L.asoc_id='$asocId' AND S.scara_id='$scaraP' ORDER BY L.loc_id ASC";
                              ...
                              while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {                                    
                                    if ($row['scara'] != $scara) {
                                        if ($scara != '') echo '</table>';
                                        $scara = $row['scara'];
                                        echo '<table cellspacing=1 cellpadding=3 style="margin:0px 0 0 0px; padding:4px;" border=0>
                                                    <tr bgcolor="#999999"><td><font size=2 color="white"><center>Etaj</center></font></td><td><font size=2 color="white"><center>Scara</center></font></td><td><font size=2 color="white"><center>Apartament</center></font></td><td><font size=2 color="white"><center>Nume</center></font></td><td><font size=2 color="white"><center>AR 1</center></font></td><td><font size=2 color="white"><center>AR 2</center></font></td><td><font size=2 color="white"><center>AR 3</center></font></td><td><font size=2 color="white"><center>AR 4</center></font></td><td><font size=2 color="white"><center>AR 5</center></font></td><td><font size=2 color="white"><center>AC 1</center></font></td><td><font size=2 color="white"><center>AC 2</center></font></td><td><font size=2 color="white"><center>AC 3</center></font></td><td><font size=2 color="white"><center>AC 4</center></font></td><td><font size=2 color="white"><center>AC 5</center></font></td></tr>';                                                    
                                    }
            ...
            echo '<input type="hidden" name="la" value="'.$editLoc.'" />';
                while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {                                    
                    if ($row['scara'] != $scara) {
                        if ($scara != '') echo '</table>';
                        $scara = $row['scara'];
                        echo '<table cellspacing=1 style="margin:0px 0 0 0px;" border=0>
                                    <tr bgcolor="#999999"><td><font size=2 color="white"><center>Etaj</center></font></td><td><font size=2 color="white"><center>Scara</center></font></td><td><font size=2 color="white"><center>Apartament</center></font></td><td><font size=2 color="white"><center>Nume</center></font></td><td><font size=2 color="white"><center>AR 1</center></font></td><td><font size=2 color="white"><center>AR 2</center></font></td><td><font size=2 color="white"><center>AR 3</center></font></td><td><font size=2 color="white"><center>AR 4</center></font></td><td><font size=2 color="white"><center>AR 5</center></font></td><td><font size=2 color="white"><center>AC 1</center></font></td><td><font size=2 color="white"><center>AC 2</center></font></td><td><font size=2 color="white"><center>AC 3</center></font></td><td><font size=2 color="white"><center>AC 4</center></font></td><td><font size=2 color="white"><center>AC 5</center></font></td><td><font size=2 color="white"><center>Optiuni</center></font></td></tr>';                                                    
                    }    
                    if ($m %2 == 0) echo '<tr align=center>'; else echo '<tr align=center bgcolor="#f1f2f2">';
                    echo '<td ><center>'.$row['etaj'].'</center></td>';
                    echo '<td ><center>'.$row['scara'].'</center></td>';                                    
